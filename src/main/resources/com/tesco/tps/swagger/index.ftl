...
<html>
<head>
  <title>Cost Amend Service</title>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      window.authorizations.add("X-Client-Id", new ApiKeyAuthorization("X-Client-Id", "SwaggerUI", "header"));      
      window.swaggerUi = new SwaggerUi({
        url: "${contextPath}/docs-api",
      ...
      function addApiKeyAuthorization() {
        ...
        if(key && key.trim() != "") {
            log("added key " + key);
            window.authorizations.add("Authorization", new ApiKeyAuthorization("Authorization", "Bearer "+key, "header"));
        }
      }
...
<div id='header'>
  <div class="swagger-ui-wrap">
    <a id="logo" href="#">CAS</a>
    <form id='api_selector'>
      <div class='input'><input placeholder="http://.../docs-api" id="input_baseUrl" name="baseUrl" type="text"/></div>
      <div class='input'><input placeholder="access token" id="input_apiKey" name="apiKey" type="text"/></div>
