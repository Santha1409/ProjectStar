package com.tesco.tps.domain;

import com.fasterxml.jackson.annotation.JsonIgnore;
import com.tesco.tps.constant.CostAmendConstants;
import com.tesco.tps.core.annotation.Document;
import com.tesco.tps.core.annotation.Id;
import com.tesco.tps.core.domain.AuditableCouchbaseDomain;

@Document(idPrefix = CostAmendConstants.KEY_PREFIX_COSTAMEND)
public class CostAmendRequest extends AuditableCouchbaseDomain {

	/**
	 * 
	 */
	private static final long serialVersionUID = -5621701788642224771L;
